...
public class bee_pair {
    ...
    public bee_pair() {
        this.angle = Math.toRadians(160);
        this.x = (int) (Math.cos(angle) * 110 + -650);
        this.y = -(int) (Math.sin(angle) * 110 + 150);
        this.s = 0.2;
        ...
        this.head_c = new Color(255, 0, 0);
        this.extras_c = new Color(0, 0, 0);
        this.body_c = new Color(66, 5, 78);
    ...
    public void update() {
        ...
        // x' = x0 + r*cos(theta)
        // y' = y0 + r*sin(theta)
        x = (int) (Math.cos(angle) * 110 + -650);
        y = -(int) (Math.sin(angle) * 110 + 150);
